...
public class WebDriverManager {
	...
	@BeforeClass()
	public void launchbrowser(@Optional("firefox")String browser,@Optional("10.60.141.26")String hubIP,@Optional("https://10.60.141.19:8443/univmax/") String applicationURL) throws MalformedURLException, InterruptedException {
