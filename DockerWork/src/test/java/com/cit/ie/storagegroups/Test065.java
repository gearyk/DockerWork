...
public class Test065 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _065_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test065");
		sgName="00DC65";
		...
		HelperMethods.printTimeFinish("TEST065");
	}
