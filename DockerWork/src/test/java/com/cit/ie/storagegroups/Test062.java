...
public class Test062 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _062_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test062");
		sgName="00DC62";
		...
		HelperMethods.printTimeFinish("TEST062");
	}
