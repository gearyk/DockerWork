...
public class Test047 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _047_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test047");
		sgName="00DC47";
		...
		HelperMethods.printTimeFinish("TEST047");
	}
