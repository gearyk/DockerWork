...
public class Test046 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _046_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test046");
		sgName="00DC46";
		...
		HelperMethods.printTimeFinish("TEST046");
	}
