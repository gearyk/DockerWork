...
public class Test056 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _056_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test056");
		sgName="00DC56";
		...
		HelperMethods.printTimeFinish("TEST056");
	}
