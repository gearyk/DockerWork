...
public class Test054 extends WebDriverManager{
	...
	@Test(priority=2)
	private void _054_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCTRUE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test054");
		sgName="00DC54";
		...
		HelperMethods.printTimeFinish("TEST054");
