...
public class Test017 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _017_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test017");
		sgName="00DC17";
		...
		HelperMethods.printTimeFinish("TEST017");
	}
