...
public class Test039 extends WebDriverManager{
	...
	@Test(priority=2)
	private void _039_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCTRUE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test039");
		sgName="00DC39";
