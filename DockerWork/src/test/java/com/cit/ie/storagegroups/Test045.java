...
public class Test045 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _045_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test045");
		sgName="00DC45";
		...
		HelperMethods.printTimeFinish("TEST045");
	}
