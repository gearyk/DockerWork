...
public class Test032 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _032_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test032");
		sgName="00DC32";
		...
		HelperMethods.printTimeFinish("TEST032");
	}
