...
public class Test040 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _040_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test040");
		sgName="00DC40";
		...
		HelperMethods.printTimeFinish("TEST040");
	}
