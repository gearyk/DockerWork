...
public class Test048 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _048_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test048");
		sgName="00DC48";
		...
		HelperMethods.printTimeFinish("TEST048");
