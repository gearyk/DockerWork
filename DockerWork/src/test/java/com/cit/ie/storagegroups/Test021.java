...
public class Test021 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _021_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test021");
		sgName="00DC21";
		...
		HelperMethods.printTimeFinish("TEST021");
	}
