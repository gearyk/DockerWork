...
public class Test031 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _031_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test031");
		sgName="00DC31";
		...
		HelperMethods.printTimeFinish("TEST031");
	}
