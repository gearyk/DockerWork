...
public class Test049 extends WebDriverManager{
	...
	@Test(priority=2)
	private void _049_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCTRUE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test049");
		sgName="00DC49";
		...
		pswpo.jsClickElement(pswpo.editStorageGroupIcon);
		pswpo.jsClickElement(pswpo.allocateCapacityCB);
		pswpo.jsClickElement(pswpo.applyEditSGOptionsButton);
		Thread.sleep(3000);
		...
		HelperMethods.printTimeFinish("TEST049");
