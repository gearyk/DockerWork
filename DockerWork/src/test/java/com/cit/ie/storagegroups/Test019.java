...
public class Test019 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _019_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test019");
		sgName="00DC19";
		...
		HelperMethods.printTimeFinish("TEST019");
