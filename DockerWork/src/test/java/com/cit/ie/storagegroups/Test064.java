...
public class Test064 extends WebDriverManager{
	...
	@Test(priority=2)
	private void _064_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCTRUE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test064");
		sgName="00DC64";
		...
		HelperMethods.printTimeFinish("TEST064");
