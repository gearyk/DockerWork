...
public class Test026 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _026_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test026");
		sgName="00DC26";
		...
		HelperMethods.printTimeFinish("TEST026");
	}
