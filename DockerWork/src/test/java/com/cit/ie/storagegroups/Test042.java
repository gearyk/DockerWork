...
public class Test042 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _042_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test042");
		sgName="00DC42";
		...
		HelperMethods.printTimeFinish("TEST042");
	}
