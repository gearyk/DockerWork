...
public class Test061 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _061_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test061");
		sgName="00DC61";
		...
		HelperMethods.printTimeFinish("TEST061");
	}
