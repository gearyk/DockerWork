...
public class Test018 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _018_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test018");
		sgName="00DC18";
		...
		HelperMethods.printTimeFinish("TEST018");
