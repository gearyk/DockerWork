...
public class Test055 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _055_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test055");
		sgName="00DC55";
		...
		HelperMethods.printTimeFinish("TEST055");
	}
