...
public class Test058 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _058_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test058");
		sgName="00DC58";
		...
		HelperMethods.printTimeFinish("TEST058");
