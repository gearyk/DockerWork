...
public class Test052 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _052_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test052");
		sgName="00DC52";
		...
		HelperMethods.printTimeFinish("TEST052");
	}
