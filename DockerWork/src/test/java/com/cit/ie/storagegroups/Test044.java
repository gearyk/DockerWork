...
public class Test044 extends WebDriverManager{
	...
	@Test(priority=2)
	private void _044_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCTRUE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test044");
		sgName="00DC44";
		...
		HelperMethods.printTimeFinish("TEST044");
