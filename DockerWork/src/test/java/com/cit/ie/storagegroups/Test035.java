...
public class Test035 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _035_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test035");
		sgName="00DC35";
		...
		HelperMethods.printTimeFinish("TEST035");
	}
