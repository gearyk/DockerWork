...
public class Test037 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _037_CREATE_EMPTY_SG_AND_VOLUME_DETAILS_DEFINED() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test037");
		sgName="00DC37";
		...
		HelperMethods.printTimeFinish("TEST037");
	}
