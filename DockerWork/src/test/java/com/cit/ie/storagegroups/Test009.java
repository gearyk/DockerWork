...
public class Test009 extends WebDriverManager{
	...
	private void _009_CREATE_STORAGEGROUP_SRPDEFAULT_SLOID2_WLOLTP_1GB() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test009");
		sgName="00DC09";
		...
		//SET SLO
		pswpo.setSloInformation(pswpo,"Diamond");
		//SET WORKLOAD
		pswpo.setWorkloadInformation(pswpo,"oltp");
		//SET VOLUME INFO
		pswpo.setVolumeInformation(pswpo,"1","1","GB");
		...
		HelperMethods.printTimeFinish("TEST009");
