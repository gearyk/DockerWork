...
public class Test051 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _051_CREATE_EMPTY_SG_WITH_SRP() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test051");
		sgName="00DC51";
		...
		HelperMethods.printTimeFinish("TEST051");
	}
