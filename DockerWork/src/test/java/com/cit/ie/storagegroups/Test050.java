...
public class Test050 extends WebDriverManager{
	...
	@Test(priority=1)
	private void _050_CREATE_STORAGEGROUP_EMPTYSETTOTRUE_SRPNONE_SLONONE_WLNONE_ALLOCFALSE() throws JSONException, IOException, InterruptedException {
		HelperMethods.printTimeStart("Test050");
		sgName="00DC50";
		...
		HelperMethods.printTimeFinish("TEST050");
	}
